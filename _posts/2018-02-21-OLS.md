...
发现我的博客不支持 LaTeX 的 align 环境，请前往 Jupyter Notebook 生成的 [HTML 版本](http://lijiawei.cc/introDataScience/OLS.html)。
...
![linregWedge2Wedge](http://lijiawei.cc/images/linregWedge2Wedge.png)
...
![surfaceQuad](http://lijiawei.cc/images/surfaceQuad.png)
...
![projection](http://lijiawei.cc/images/projection.png)
