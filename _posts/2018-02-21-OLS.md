...
![linregWedge2Wedge](http://lijiawei.cc/introDataScience/img/linregWedge2Wedge.png)
...
![linRegContoursSSE](http://lijiawei.cc/introDataScience/img/linRegContoursSSE.png)
...
我们先看 $$\nabla_{w}w^Ta$$ 的情况，$$a = \begin{bmatrix}
a_0\\ 
a_1\\ 
a_2
\end{bmatrix}$$，用标量形式表示就是 $$w^Ta = w_0a_0 + w_1a_1+w_2a_2$$，可得
...
![surfaceQuad](http://lijiawei.cc/introDataScience/img/surfaceQuad.png)
...
![projection](http://lijiawei.cc/introDataScience/img/projection.png)
